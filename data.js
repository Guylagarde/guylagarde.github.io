// ══════════════════════════════════════════════════════════════════
//  DONNÉES DU SITE — Guy Lagarde Photographie
//  Modifiez ce fichier pour ajouter/modifier thèmes et légendes
// ══════════════════════════════════════════════════════════════════

const SIGNATURE = "https://eapi.pcloud.com/getpubthumb?code=XZDOBiZ1EE9bXpyGwyFzsPUr70rK5xvOdX7&size=400x200&crop=0&type=auto";
const BASE_URL = "https://eapi.pcloud.com";
...
const EUROPE = [
  {
    ...
    nom: "France",
    flag: "🇫🇷",
    legende: "De Marseille à la Charente, fragments d'une France intime et festive.",
    themes: [
      { id: "mucem", nom: "Au MuCEM de Marseille", legende: "", code: "kZiCavZVSQptHe2wfzmJVKNsVHg87QRa2Fy", blog: false },
      { id: "tonneliers", nom: "Cimetière des Tonneliers", legende: "", code: "kZeCavZakkjQGYUeYHQDN7BJ3EvX8hCaqSX", blog: false },
      ...
      { id: "paysages-fr", nom: "Paysages Divers", legende: "", code: "kZPWBiZV5IGbnv6NH4id3avScUdihg4ChqV", blog: false },
      { id: "barrobjectif", nom: "Mon Expo Barrobjectif 2023", legende: "", code: "kZg6BiZwl6C8nPXzpVgWBcDUy5USJrfok70", blog: false },
    ],
    videos: []
  },
  {
    ...
    themes: [
      { id: "espagne", nom: "L'Espagne", legende: "", code: "kZuWBiZ9wW3gDBCGbfWzPRUrY6ehRwcMPiy", blog: false },
    ],
    videos: [
      { titre: "Carte postale Madrid", url: "https://youtu.be/z5nk8yZ7cE8" },
      { titre: "Carte postale Caceres", url: "https://youtu.be/M2HGkH2nhZA" },
      { titre: "Carte postale Salamanca", url: "https://youtu.be/90z43Vp3bys" },
      { titre: "Carte postale Trujillo", url: "https://youtu.be/F_f5Fv00eBM" },
      { titre: "Carte postale Tolède", url: "https://youtu.be/lHJnoelLph4" },
      { titre: "Carte postale Zaragoza", url: "https://youtu.be/B6UrEdiHSHw" },
    ]
  },
  {
    id: "italie",
    ...
    themes: [
      { id: "ischia", nom: "Ischia & Procida", legende: "", code: "kZBWBiZKqrJxlmRKAVNgCrTUXBENkLHSfBk", blog: false },
      { id: "venise", nom: "Venise & Burano", legende: "", code: "kZWWBiZGRQ8PQ64ENmPGieAPFRM8jksPzQX", blog: false },
    ],
    videos: [
      { titre: "Venise en images", url: "https://youtu.be/2wXnisjKQdk" },
    ]
  },
  {
    id: "grece",
  ...
  },
  {
    ...
    nom: "Portugal",
    flag: "🇵🇹",
    legende: "Lisbonne et ses collines, ville mélancolique et solaire.",
    themes: [
      { id: "lisbonne", nom: "Lisbonne", legende: "", code: "kZ1WBiZLJyxEneRx8Xnrg5w4dNfLY5uYECV", blog: false },
    ],
    videos: []
  },
  {
...
const ASIE = [
  {
    ...
    themes: [
      { id: "balinaises", nom: "Cérémonies Balinaises", legende: "", code: "kZ5xavZ8JvhAixeDfQpaaMFuyqQXy91NUpX", blog: false },
      { id: "buffles", nom: "Courses de Buffles Jembrana", legende: "", code: "kZ1xavZEvaqjHXnhwz5UAzIBVrmJBLurd5X", blog: false },
      ...
      { id: "ijen", nom: "Le Kawah Ijen", legende: "", code: "kZixavZmMdF8A9sl5XNHIpd9pQzwpWK5faV", blog: true },
      ...
      { id: "jakarta", nom: "Petits Boulots à Jakarta", legende: "", code: "kZo2BiZU2TOtbPbCRuMt827mlGkiJJKlytV", blog: false },
      { id: "sumba", nom: "L'Île de Sumba", legende: "", code: "kZ7WBiZ7JKwfATuzGRrnNb34nC5fRU6hUHk", blog: false },
    ],
    videos: [
      { titre: "Flores et Komodo", url: "https://youtu.be/LPeh6BAK1ho" },
      { titre: "L'île de Sumba", url: "https://youtu.be/B69_ffjQ3-g" },
    ]
  },
  {
    id: "japon",
    ...
    themes: [
      { id: "japon", nom: "Tokyo, Kyoto, Osaka", legende: "", code: "kZXWBiZ9GRi7L5bLyXua6XBPLIki7g30LC7", blog: false },
    ],
    videos: [
      { titre: "Le Japon en images", url: "https://youtu.be/IJAE_d1atfA" },
    ]
  },
  {
    id: "cambodge",
    ...
    nom: "Cambodge",
    flag: "🇰🇭",
    legende: "Les temples d'Angkor, joyaux de la civilisation khmère.",
    themes: [
      { id: "angkor", nom: "Les Temples d'Angkor", legende: "", code: "kZP2BiZnjYcLzPl7vF9PnDnlvCiQFW0CSny", blog: false },
    ],
    videos: []
  },
  {
    ...
    nom: "Vietnam",
    flag: "🇻🇳",
    legende: "Hanoi et la baie d'Along terrestre — entre fleuve et karst.",
    themes: [
      { id: "vietnam", nom: "Hanoi et la Baie d'Along Terrestre", legende: "", code: "kZQWBiZMwRTfoI1JV5xFjFrF9CJM7rGwqk0", blog: false },
    ],
    videos: [
      { titre: "Vietnam en images", url: "https://youtu.be/pSs7iwehgkQ" },
    ]
  },
  {
    id: "malaisie",
    ...
    nom: "Malaisie",
    flag: "🇲🇾",
    legende: "Des Cameron Highlands aux marchés colorés d'Asie.",
    themes: [
      { id: "cameron", nom: "Les Cameron Highlands", legende: "", code: "kZzWBiZvRtMvjIxlIQfI0ryO8YkpHoKgdpV", blog: false },
    ],
    videos: []
  },
  {
    id: "marches-asie",
    nom: "Les Marchés d'Asie",
    flag: "🛒",
    legende: "Des marchés colorés à travers toute l'Asie.",
    themes: [
      { id: "marches", nom: "Les Marchés d'Asie", legende: "", code: "kZJWBiZSptw0IPDbNyRQbPRSfPRQjrHHo97", blog: false },
    ],
    videos: []
  },
  {
    ...
    themes: [
      { id: "portraits-bw", nom: "Portraits Surpris — Noir & Blanc", legende: "", code: "kZoS2iZiCbaIURjc3j6AhrHjp5o8HajyjAy", blog: false },
...
// ── THÈMES TRANSVERSAUX ───────────────────────────────────────────
const TRANSVERSAUX = [
  { id: "portraits-asie", nom: "Portraits Surpris en Asie", legende: "", code: "kZ4wavZwPtgzAXuCb4evfTrlb043jTpHFMX", blog: false },
];
...
const RECITS = {
  chasseur: {
    ...
    date: "Bali, Indonésie",
    coverUrl: "https://filedn.eu/lSAOB0qLt5khinrvMgAwVqV/LE%20CHASSEUR%20DE%20NUAGES/28122016-DSC06731.jpg",
    paragraphes: [
      ...
      "Juste avant que quitter les lieux, je suis repassé devant l\'entrée du temple et j\'ai aperçu la frêle silhouette de celui qui venait d\'accomplir l\'impensable se détacher sur des volutes de fumée âcre dans une espèce de modeste révérence qui m\'a semblé être le signe du devoir accompli !"
    ]
  },
  ijen: {
    titre: "Le Kawah Ijen — Plonger dans le cratère aux flammes bleues",
    date: "Bali, Indonésie",
    coverUrl: "https://filedn.eu/lSAOB0qLt5khinrvMgAwVqV/LE%20KAWA%20IJEN/23052016-DSC04267.jpg",
    paragraphes: [
  ...
  batur: {
    ...
    date: "Bali, Indonésie",
    coverUrl: "https://filedn.eu/lSAOB0qLt5khinrvMgAwVqV/LE%20MONT%20ET%20LE%20LAC%20BATUR/04052016-DSC04010.jpg",
    paragraphes: [
      "29 avril 2016.",
